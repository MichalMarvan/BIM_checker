...
export const AGENT_PRESETS = [
    {
        ...
        nameEn: 'Generalist',
        icon: '🤖',
        descriptionCs: 'Univerzální asistent s přístupem ke všem toolům (lokální AI dostává štíhlou výchozí sadu).',
        descriptionEn: 'General-purpose assistant with access to all tools (local AI gets a slim default set).',
        enabledTools: null,
